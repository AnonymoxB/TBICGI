report 60507 PostedTransferShipment
{
    UsageCategory = ReportsAndAnalysis;
    Caption = 'Transfer Shipment Form';
    ApplicationArea = All;
    DefaultLayout = RDLC;

    RDLCLayout = './Rdlc/PostedTransferShipment.rdl';
    dataset
    {
        dataitem("Transfer Shipment Header"; "Transfer Shipment Header")
        {
            ...
            dataitem("Transfer Shipment Line"; "Transfer Shipment Line")
            {
                ...
                {
                    DataItemLink = "Document No." = field("Item No."), "Location Code" = field("Transfer-from Code");
                    column(Cost_Amount__Actual_; "Cost Amount (Actual)") { }
                    trigger OnAfterGetRecord()
                    begin
                        TotalAmount := TotalAmount + "Cost Amount (Actual)";
                    end;
                }
            }
        }
